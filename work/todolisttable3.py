...
"font: 75 48pt \"Century Gothic\";")
    ...
    def add_task(self):
        ...
        if len(new_task) == 0 or len(new_date) == 0:
            ...
            return None
        if len(new_date)<8:
            self.infolabel.setText("Incorrect form of date/ leading zero is not allow")
            return None
        if new_date.isalpha():
    ...
    def remove_task(self):
     ...
     #ปัญหา กด clear แล้ว  หายแค่ตอนแรก add อันอื่นอัเก่ากลับมา
    def clear_task(self):
            self.tableWidget.clearContents()
            self.tableWidget.setRowCount(0)
    ...
    def create(self):
        ...
        #create new events
         #ปัญหาไม่รู้จะเอา ข้อมูลจากตารางมาใส่ยังไง   
        ...
        create_event(datetime(2021, 12,28), "python project")
...
"CALENDAR"))
        ...
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "x/x/xxxx"))
